...
<div class="max-w-2xl bg-white rounded-2xl shadow-card border border-slate-100 p-8">
    ...
    <div class="mt-8 flex gap-3"><a href="{{ route('admin.faqs.edit',$faq) }}" class="px-5 py-2.5 rounded-xl bg-black text-white font-semibold">Edit</a><a href="{{ route('admin.faqs.index') }}" class="px-5 py-2.5 rounded-xl border">Kembali</a></div>
</div>
@endsection

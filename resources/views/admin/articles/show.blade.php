...
<div class="max-w-3xl bg-white rounded-2xl shadow-card border border-slate-100 overflow-hidden">
    ...
    <div class="p-8">
        ...
        <div class="mt-8 flex gap-3"><a href="{{ route('admin.articles.edit',$article) }}" class="px-5 py-2.5 rounded-xl bg-[#0F2A4A] text-white font-semibold">Edit</a><a href="{{ route('admin.articles.index') }}" class="px-5 py-2.5 rounded-xl border">Kembali</a></div>
    </div>
</div>
@endsection

...
<div class="bg-white rounded-2xl shadow-card border border-slate-100 overflow-hidden">
    <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.clients.create') }}" class="inline-flex items-center gap-2 bg-black hover:bg-black text-white px-5 py-2.5 rounded-xl text-sm font-semibold"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg> Tambah Client</a>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <div class="border border-slate-200 rounded-2xl p-5 hover:shadow-soft hover:border-[#0F2A4A]/20 transition bg-white group">
                ...
                <div class="mt-4 flex gap-1.5">
                    ...
                    <a href="{{ route('admin.clients.edit',$client) }}" class="flex-1 py-2 rounded-xl bg-black text-white text-center text-xs font-semibold hover:bg-black">Edit</a>

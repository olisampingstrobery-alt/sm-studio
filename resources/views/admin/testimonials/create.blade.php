...
<div class="w-full bg-white rounded-2xl shadow-card border border-slate-100 overflow-hidden">
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 lg:p-8 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            ...
            <div><label class="block text-sm font-semibold mb-1.5">Foto</label><input type="file" name="photo" accept="image/*" class="w-full rounded-xl border-slate-200 text-sm file:mr-3 file:py-2 file:px-3 file:rounded-lg file:border-0 file:bg-black file:text-white file:text-xs file:font-semibold hover:file:bg-black"></div>
        </div>

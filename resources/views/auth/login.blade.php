        ...
        <div class="w-full max-w-md">
            <div class="text-center mb-6">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-2">
                    <span class="w-9 h-9 rounded-xl bg-black text-white grid place-items-center font-black">SM</span>
            ...
            <div class="bg-white rounded-[20px] shadow-card border border-slate-100 p-8">
                ...
                <a href="{{ route('admin.login') }}" class="mt-6 block w-full text-center bg-black hover:bg-black text-white font-semibold py-3 rounded-xl">Ke Halaman Admin Login</a>
